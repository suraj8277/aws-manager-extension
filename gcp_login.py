...
def main():
    ...
    if not project or not zone:
        ...
        print("Note: MIGs (Managed Instance Groups) usually don't have a direct SSH zone.")
        sys.exit(1)

    print(f"Found: Project={project}, Zone={zone}")
    print(f"Connecting to {server_name} via IAP tunnel...")
    ...
    try:
        ...
        # Added shell=True for Windows compatibility with script-based commands
